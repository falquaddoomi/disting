...
ALLOWED_HOSTS = ['dainsleif.dyndns.org', 'hrungnir.dyndns.org', 'disting.dyndns.org', 'localhost']
...
SECRET_KEY = 'l49016e3y4)@!+np8and@&fz2@g5wlu^k9rri-5@#ky0tp&*+='
...
ROOT_URLCONF = 'compgraph_web.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'compgraph_web.wsgi.application'
